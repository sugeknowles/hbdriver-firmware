...
int main(void) {
  ...
  while(1) {
    ...
    // Disable serial timeout beep, annoying while debugging  
    ...
    } else if (timeoutFlagADC || timeoutCnt > TIMEOUT) { // beep in case of ADC timeout, Serial timeout or General timeout - fast beep      
      buzzerFreq    = 24;
      buzzerPattern = 1;
